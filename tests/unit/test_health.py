...
class TestHealthChecker:
    ...
    async def test_check_queue_system_healthy(self, mock_supabase_queue, mock_settings, health_checker):
    ...
    @patch('app.core.config.settings')
    @patch('app.infrastructure.queues.supabase_queue.SupabaseQueue')
    async def test_check_queue_system_unhealthy(self, mock_supabase_queue, mock_settings, health_checker):
    ...
    async def test_check_external_apis_together_ai_healthy(self, mock_httpx_client, mock_settings, health_checker):
    ...
    @patch('app.core.config.settings')
    @patch('httpx.AsyncClient')
    async def test_check_external_apis_together_ai_unhealthy(self, mock_httpx_client, mock_settings, health_checker):
    ...
    @patch('app.core.config.settings')
    @patch('httpx.AsyncClient')
    async def test_check_external_apis_exception(self, mock_httpx_client, mock_settings, health_checker):
    ...
    async def test_check_all_healthy(self, mock_settings_checker, mock_settings_config, health_checker):
        ...
        health_checker.check_queue_system = AsyncMock(return_value={"status": "healthy"})
    ...
    @patch('app.core.config.settings')
    @patch('app.health.settings')
    async def test_check_all_unhealthy_database(self,mock_settings_checker, mock_settings_config, health_checker):
    ...
    async def test_check_all_with_exceptions(self, mock_settings, health_checker):
        ...
        health_checker.check_queue_system = AsyncMock(side_effect=Exception("Queue error"))
        health_checker.check_external_apis = AsyncMock(side_effect=Exception("API error"))
...
class TestCheckFunction:
    ...
    async def test_check_success(self, mock_print, mock_close_connections, mock_tortoise_init):
    ...
    @patch('app.health.Tortoise.close_connections')
    @patch('builtins.print')
    async def test_check_unhealthy(self, mock_print, mock_close_connections, mock_tortoise_init):
