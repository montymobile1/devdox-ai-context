...
DB_REPO_PARENT_ID_UPDATE_FAILED = "Failed to update repo parent id"
...
ERROR_REPO_NOT_FOUND_BY_REPO_ID= "Error finding repo by repo_id {repo_id}"
ERROR_REPO_NOT_FOUND_BY_ID= "Error finding repo by id {id}"
